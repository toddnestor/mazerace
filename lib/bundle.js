	...
	var Solver = function () {
	  ...
	  _createClass(Solver, [{
	    ...
	    value: function step(algorithm) {
	      var square = algorithm.nextSquare();
	      if (square) {
	        if (square.squareType !== 'start' && square.squareType !== 'end') {
	        ...
	        if (square.squareType === 'end') {
	          ...
	          var newStore = algorithm.processSquare(square);
	      ...
	      if (!this.paused) {
	        (function () {
	          ...
	          setTimeout(function () {
	            ...
	            if (!_this2.firstDone || !_this2.secondDone && secondAlgorithm || !secondAlgorithm) {
	              _this2.search();
	            } else {
