...
/***/ function(module, exports, __webpack_require__) {
	...
	var AStar = function (_BestFS) {
	  ...
	  function AStar(grid) {
	    ...
	    var _this = _possibleConstructorReturn(this, (AStar.__proto__ || Object.getPrototypeOf(AStar)).call(this, grid));
	  ...
	  _createClass(AStar, [{
	    ...
	    value: function nextSquare() {
	      ...
	      this.store.forEach(function (square) {
	        var distance = _this2.distanceFromEnd(square) + _this2.gScore(square);
	
	        if (distanceFromEnd === null || distance < distanceFromEnd) {
	          distanceFromEnd = distance;
	          bestSquare = square;
	        } else if (distance === distanceFromEnd && square.parent && square.parent == _this2.lastChecked) {
	          bestSquare = square;
	        }
	      });
	    ...
	    value: function processSquare(square) {
	      ...
	      neighbors.forEach(function (neighbor) {
	        var gScore = _this3.gScore(square) + _this3.gScoreAddition(square, neighbor);
...
=======
	  ...
	  _createClass(BestFS, [{
>>>>>>> c69b9849b79bff94dc66ac5b008e3856231d40c1
	    key: 'nextSquare',
	    value: function nextSquare() {
	      var _this2 = this;
	    ...
	    key: 'removeSquareFromStore',
	    value: function removeSquareFromStore(square) {
	      var newStore = [];
