	    ...
	    value: function search(firstAlgorithm) {
	      ...
	      if (square) {
	        ...
	        if (square.squareType === 'end') {
	          ...
	          if (square.parent && square.parent.squareType !== 'start') {
	            this.grid.setAsChecked(square.parent);
	          }
	
	          firstAlgorithm.processSquare(square);
	
	          setTimeout(function () {
	            if (square.squareType !== 'start') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BFS = function (_AlgorithmBase) {
	  ...
	  function BFS(grid) {
	    ...
	    return _possibleConstructorReturn(this, (BFS.__proto__ || Object.getPrototypeOf(BFS)).call(this, grid));
	  }
	  ...
	  _createClass(BFS, [{
	    ...
	    value: function processSquare(square) {
	      ...
	      neighbors.forEach(function (neighbor) {
	        if (!_this2.alreadySeen(neighbor)) {
	          neighbor.parent = square;
	          _this2.store.push(neighbor);
	          _this2.makeSeen(neighbor);
	        }
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DFS = function (_AlgorithmBase) {
	  ...
	  function DFS(grid) {
	    ...
	    return _possibleConstructorReturn(this, (DFS.__proto__ || Object.getPrototypeOf(DFS)).call(this, grid));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BestFS = function (_AlgorithmBase) {
	  ...
	  function BestFS(grid) {
	    ...
	    return _possibleConstructorReturn(this, (BestFS.__proto__ || Object.getPrototypeOf(BestFS)).call(this, grid));
	  }
