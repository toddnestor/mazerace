...
Maze Race compares algorithms such as Breadth First Search, A*, Best First Search, and Depth First Search.  Maze Race is inspired by [Pathfinder.js](https://qiao.github.io/PathFinding.js/visual/)
...
- [ ] View stats about the algorithms including how many steps it took to solve the maze and the length of the final path
